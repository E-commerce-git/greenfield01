        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              ...
              Our goal is to exceed your expectations and deliver quality at every turn.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-gray-400 hover:text-blue-500 transition duration-200">Home</a></li>
              <li><a href="#" className="text-sm text-gray-400 hover:text-blue-500 transition duration-200">Shop</a></li>
              <li><a href="#" className="text-sm text-gray-400 hover:text-blue-500 transition duration-200">Contact</a></li>
              <li><a href="#" className="text-sm text-gray-400 hover:text-blue-500 transition duration-200">Privacy Policy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-gray-400">123 Main Street</li>
              <li className="text-sm text-gray-400">New York, NY 10001</li>
              <li className="text-sm text-gray-400">Phone: (123) 456-7890</li>
              <li className="text-sm text-gray-400">Email: info@example.com</li>
            </ul>
          </div>
